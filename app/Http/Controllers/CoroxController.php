...
class CoroxController extends Controller {
  ...
  public function registerShowSignUp(){
            return view('signup',['title'=>'Forgot Password']);
  }
  // show login here
  ...
  public  function registerResetPassword(Request $request){
    if($_SERVER['REQUEST_METHOD'] =='POST'){
      ...
      return view('reset-password', ['date'=>$date, 'schoolInformation'=>$schoolInformation,  'staffInformation'=> $staffInformation, 'userEmail'=>$adminEmail, 'userId'=>$userId,'title'=>'Forgot Password']);
    }
  ...
  public  function registerChangePassword(Request $request){
    ...
    return view('change-password',['checker'=>$checker,'title'=>'Change Password']);
  }   
