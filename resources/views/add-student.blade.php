...
<head>
  ...
  <title>The Register - Add Student</title>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-danger"> Add New Student </h6>
                ...
                <div class="card-body" id="student-body">
                  ...
                  @endif
                  <form class="form" action="/Dregister/add-student" enctype="multipart/form-data" method="POST">
                     {{csrf_field()}}
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                      ...
                      <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                          <label for="register-number"  class="control-label text-info"> Registeration Number</label>
                            <input type="text" id="registerNumber" name="registerNumber" class="form-control" placeholder="Enter Registeration Number">                        </div>
                      </div>                                                  
                     </div>
                    <div class="row">
                      <div class="col-md-6 col-sm-6">
                        ...
                        <div class="form-group">
                           <label for="class-name" class="control-label text-info" > Parent's Name</label>
                                <select class="form-control" id="parentName" name="parentName">
                                   <option value="none">Select-Parent's-Name</option>
                                    @if($parents !=null )
