...
<head>
  ...
  <title>The Register - Edit Parent</title>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  ...
                  <div class="float-right text-danger " id="editParent\Toggle"><i class="fas fa-plus" id="close"></i></div>
                </div>
                <div class="card-body" id="edit-parent-body">
                  ...
                  @endif
                <form class="form" action="/Dregister/update-parent" enctype="multipart/form-data" method="POST">
                    {{method_field('PUT')}}
                     ...
                     <div class="row">
                        <div class="col-md-6 col-sm-6 ">                      
                           <div class="form-group">             
                            <img src="{{$parentInformation->parent_profile_image !== null || $parentInformation->parent_profile_image !='' ? url('uploads/'.$parentInformation->parent_profile_image) : asset('my-register/img/The-Register.jpg') }}" width=200 height=150 class="col-md-4 col-sm-4 img-responsive img-rounded">                                 
                           </div>
                        </div>                           
                      </div>                     
                     <div class="row">
