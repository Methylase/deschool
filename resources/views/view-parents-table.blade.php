...
<head>
  ...
  <title>The Register - View Parents Table</title>
         ...
         $('#viewParentsToggle').click(function(){
          ...
          var delParent = $(this).attr('id');
           ...
           $('#del_parent'+delParent[1]).on('click', function(){
            ...
            $.ajax({
               type: "DELETE",
               url: "/Dregister/delete-parent/"+delParent[1],
               data: values,
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                          <h6 class="m-0 font-weight-bold text-info">Parents Table</h6>
                           <a href="/Dregister/add-parent" class="btn btn-sm btn-danger float-right">Add Parent</a>
                        </div>
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td>
                                             ...
                                             <a href="/Dregister/edit-parent/{{$parent->id}}" class="btn btn-sm btn-info" title="Edit"><span class="fa fa-edit"></span></a>                                         
