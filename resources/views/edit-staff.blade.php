...
<head>
  ...
  <title>The Register - Edit Staff</title>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-danger"> Edit Staff </h6>
                ...
                <div class="card-body" id="edit-staff-body">
                  ...
                  @endif
                <form class="form" action="/Dregister/update-staff" enctype="multipart/form-data" method="POST">
                    {{method_field('PUT')}}
                     ...
                     <div class="row">
                        <div class="col-md-6 col-sm-6 ">                      
                           <div class="form-group">             
                            <img src="{{$staffInformation->staff_profile_image !== null || $staffInformation->staff_profile_image !='' ? url('uploads/'.$staffInformation->staff_profile_image) : asset('my-register/img/The-Register.jpg') }}" width=200 height=150 class="col-md-4 col-sm-4 img-responsive img-rounded">                                 
                           </div>
                        </div>                           
                      </div>                     
                     <div class="row">
