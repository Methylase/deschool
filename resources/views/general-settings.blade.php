...
<head>
  ...
  <title>The Register - General Settings</title>
                  ...
                  <div class="col-lg-12 mb-4">
                     ...
                     <form class="form" action="" method="">
                        ...
                        <div class="row">
                         <div class="col-md-6 col-sm-6 ">
                           <div class="form-group">
                             <label for="class-name" class="control-label text-info"> Period Name</label>
