...
<head>
  ...
  <title>The Register - View Staffs Table</title>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                          <h6 class="m-0 font-weight-bold text-info">Staffs Table</h6>
                           <a href="/Dregister/add-staff" class="btn btn-sm btn-danger float-right">Add Staff</a>
                        </div>
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td>
                                             ...
                                             <a href="/Dregister/edit-staff/{{$staff->id}}" class="btn btn-sm btn-info" title="Edit"><span class="fa fa-edit"></span></a>                                         
